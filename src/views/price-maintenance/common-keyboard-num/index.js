    ...
    render(){  
        ...
        return(
             <div className="chengzhong" >
                 ...
                 <div className="button-combination">  
                    <div className="item-main">
                        {this.props.Whetherpoint === true && <input type='button' className='btn-item' value='.' onClick={this.itemClick}/>}
                        <input type='button' className='btn-item' value='0' onClick={this.itemClick}/>
                        <button className={this.props.Whetherpoint === true ?'btn-item':'btn-item newflex'}   onClick={this.delClick}><i className='iconfont icon-order_btn_back'></i></button> 
                    </div>
                 </div> 
            </div> 
